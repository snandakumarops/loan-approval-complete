...
public class Loan implements java.io.Serializable {
	...
	public String toString() {
	    ...
	    return "Loan Amount: "+	String.valueOf(this.amount)+",Loan Duration: "+String.valueOf(this.duration)+",Age Pre Qual: "+this.agePreQual+",Loan Pre Qual: "+this.loanPreQualification;
	}
